...
using LibRenderNext.Backgrounds;
using LibRenderNext.Cameras;
using LibRenderNext.Fogs;
using LibRenderNext.Lightings;
using LibRenderNext.Loadings;
using LibRenderNext.MotionBlurs;
using LibRenderNext.Objects;
using LibRenderNext.Overlays;
using LibRenderNext.Primitives;
using LibRenderNext.Screens;
using LibRenderNext.Shaders;
using LibRenderNext.ShadowMapping;
using LibRenderNext.Text;
using LibRenderNext.Textures;
...
namespace LibRenderNext
{
	public abstract class BaseRenderer
	{
		...
		public Core.SceneManager Scene;
...
#pragma warning restore 0219, CS0169
		...
		protected BaseRenderer(HostInterface CurrentHost, BaseOptions CurrentOptions, FileSystem FileSystem)
		{
			...
			Scene = new Core.SceneManager(this);
			Pipeline = new Pipeline.RenderPipeline();
		...
		public void InitializePipeline(Action<Pipeline.RenderContext> drawBackground, Action<Pipeline.RenderContext> drawUi)
		{
			Pipeline.Clear();
