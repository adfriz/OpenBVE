	...
	internal partial class Overlays
	{
		...
		private void RenderDebugOverlays()
		{
			...
			string[] Lines = {
				...
				"total static objects: " + (Program.Renderer.Models.StaticObjectStates.Count + Program.Renderer.Models.DynamicObjectStates.Count).ToString(Culture),
				...
				"",
				"=renderer",
				"opaque faces: " + Program.Renderer.Models.VisibleObjects.OpaqueFaces.Count.ToString(Culture),
				"alpha faces: " + Program.Renderer.Models.VisibleObjects.AlphaFaces.Count.ToString(Culture),
				"overlay opaque faces: " + Program.Renderer.Models.VisibleObjects.OverlayOpaqueFaces.Count.ToString(Culture),
				"overlay alpha faces: " + Program.Renderer.Models.VisibleObjects.OverlayAlphaFaces.Count.ToString(Culture),
