...
{
	internal class NewRendererNext : BaseRenderer
	{
		// stats
		...
		// render scene using LibRenderNext pipeline
		...
		public NewRendererNext(HostInterface currentHost, BaseOptions CurrentOptions, FileSystem fileSystem) : base(currentHost, CurrentOptions, fileSystem)
		{
