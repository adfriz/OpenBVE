...
{
    /// <summary>Fits one orthographic projection per camera sub-frustum.</summary>
    public class CascadedShadowCaster
    {
        ...
        /// <summary>PSSM lambda (0=linear, 1=log); higher = more near resolution.</summary>
        ...
        /// <summary>Recomputes all cascade matrices (call once per frame).</summary>
        ...
        public void Update(Vector3 lightDirection, Matrix4D cameraView, Matrix4D cameraProjection, double nearClip, double fovY, double aspect)
        {
            ...
            // Inverse view-projection gives frustum corners in world space
            ...
            // PSSM split distances, clamped to the shadow distance
            ...
            // Total frustum depth for split fractions
            double totalDepth = shadowFar - nearClip;
            // Inverse view for stable center calculation
            ...
            for (int i = 0; i < CascadeCount; i++)
            {
                ...
                // Light looks along its direction from the cascade center
                ...
                // Ortho projection tightly fitting the bounding sphere
                ...
                // Rebuild view matrix from the snapped center
                ...
                // Symmetric depth range: distant casters are already distance-culled.
                ...
                // Texel size as depth-buffer fraction for acne bias.
        ...
        {
            // far = Row3.Z / (Row2.Z + 1) for a standard perspective projection.
