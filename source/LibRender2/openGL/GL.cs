...
namespace OpenTK.Graphics.OpenGL
{
    ...
    {
        private static Silk.NET.OpenGL.GL gl => LibRender2.OpenGLBind.GL;

        public static void ActiveTexture(TextureUnit texture) => gl.ActiveTexture((Silk.NET.OpenGL.TextureUnit)texture);
        public static void AttachShader(int program, int shader) => gl.AttachShader((uint)program, (uint)shader);
        
        // Legacy/Immediate mode
        public static void Begin(PrimitiveType mode) => gl.Begin((Silk.NET.OpenGL.PrimitiveType)mode);
        ...
        public static void MatrixMode(MatrixMode mode) => gl.MatrixMode((Silk.NET.OpenGL.MatrixMode)mode);
        ...
        public static void BindBuffer(BufferTarget target, int buffer) => gl.BindBuffer((Silk.NET.OpenGL.GLEnum)target, (uint)buffer);
        public static void BindBufferBase(BufferRangeTarget target, uint index, int buffer) => gl.BindBufferBase((Silk.NET.OpenGL.GLEnum)target, index, (uint)buffer);
        public static void BindBufferBase(BufferTarget target, uint index, int buffer) => gl.BindBufferBase((Silk.NET.OpenGL.GLEnum)target, index, (uint)buffer);
        public static void BindBufferBase(BufferRangeTarget target, int index, int buffer) => gl.BindBufferBase((Silk.NET.OpenGL.GLEnum)target, (uint)index, (uint)buffer);
        public static void BindBufferBase(BufferTarget target, int index, int buffer) => gl.BindBufferBase((Silk.NET.OpenGL.GLEnum)target, (uint)index, (uint)buffer);
        ...
        public static void BindFramebuffer(FramebufferTarget target, int framebuffer) => gl.BindFramebuffer((Silk.NET.OpenGL.GLEnum)target, (uint)framebuffer);
        public static void BindRenderbuffer(RenderbufferTarget target, int renderbuffer) => gl.BindRenderbuffer((Silk.NET.OpenGL.GLEnum)target, (uint)renderbuffer);
        public static void BindTexture(TextureTarget target, int texture) => gl.BindTexture((Silk.NET.OpenGL.GLEnum)target, (uint)texture);
        public static void BindVertexArray(int array) => gl.BindVertexArray((uint)array);
        
        public static void BlendEquationSeparate(BlendEquationModeSeparate modeRGB, BlendEquationModeSeparate modeAlpha) => gl.BlendEquationSeparate((Silk.NET.OpenGL.GLEnum)modeRGB, (Silk.NET.OpenGL.GLEnum)modeAlpha);
        public static void BlendEquationSeparate(BlendEquationMode modeRGB, BlendEquationMode modeAlpha) => gl.BlendEquationSeparate((Silk.NET.OpenGL.GLEnum)modeRGB, (Silk.NET.OpenGL.GLEnum)modeAlpha);
        public static void BlendFunc(BlendingFactor sfactor, BlendingFactor dfactor) => gl.BlendFunc((Silk.NET.OpenGL.BlendingFactor)sfactor, (Silk.NET.OpenGL.BlendingFactor)dfactor);
        public static void BlendFuncSeparate(BlendingFactorSrc srcRGB, BlendingFactorDest dstRGB, BlendingFactorSrc srcAlpha, BlendingFactorDest dstAlpha) => gl.BlendFuncSeparate((Silk.NET.OpenGL.BlendingFactorSrc)srcRGB, (Silk.NET.OpenGL.BlendingFactorDest)dstRGB, (Silk.NET.OpenGL.BlendingFactorSrc)srcAlpha, (Silk.NET.OpenGL.BlendingFactorDest)dstAlpha);
        
        public static unsafe void BufferData<T>(BufferTarget target, IntPtr size, T[] data, BufferUsageHint usage) where T : unmanaged
        {
            fixed (void* ptr = data)
                gl.BufferData((Silk.NET.OpenGL.GLEnum)target, (nuint)size, ptr, (Silk.NET.OpenGL.GLEnum)usage);
        }
        public static unsafe void BufferData(BufferTarget target, IntPtr size, IntPtr data, BufferUsageHint usage) =>
            gl.BufferData((Silk.NET.OpenGL.GLEnum)target, (nuint)size, data.ToPointer(), (Silk.NET.OpenGL.GLEnum)usage);
        
        public static unsafe void BufferSubData<T>(BufferTarget target, IntPtr offset, IntPtr size, T[] data) where T : unmanaged
        {
            fixed (void* ptr = data)
                gl.BufferSubData((Silk.NET.OpenGL.GLEnum)target, offset, (nuint)size, ptr);
        }
        
        public static FramebufferErrorCode CheckFramebufferStatus(FramebufferTarget target) => (FramebufferErrorCode)gl.CheckFramebufferStatus((Silk.NET.OpenGL.GLEnum)target);
        ...
        {
            gl.ClearBufferSubData((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)internalformat, offset, (nuint)size, (Silk.NET.OpenGL.GLEnum)format, (Silk.NET.OpenGL.GLEnum)type, data.ToPointer());
        }
        ...
        public static void CopyTexImage2D(TextureTarget target, int level, InternalFormat internalformat, int x, int y, int width, int height, int border) =>
            gl.CopyTexImage2D((Silk.NET.OpenGL.GLEnum)target, level, (Silk.NET.OpenGL.GLEnum)internalformat, x, y, (uint)width, (uint)height, border);
            
        public static int CreateProgram() => (int)gl.CreateProgram();
        public static int CreateShader(ShaderType type) => (int)gl.CreateShader((Silk.NET.OpenGL.ShaderType)type);
        public static void CullFace(CullFaceMode mode) => gl.CullFace((Silk.NET.OpenGL.GLEnum)mode);
        ...
        public static void DepthFunc(DepthFunction func) => gl.DepthFunc((Silk.NET.OpenGL.DepthFunction)func);
        public static void DepthMask(bool flag) => gl.DepthMask(flag);
        public static void Disable(EnableCap cap) => gl.Disable((Silk.NET.OpenGL.EnableCap)cap);
        ...
        public static void DrawArrays(PrimitiveType mode, int first, int count) => gl.DrawArrays((Silk.NET.OpenGL.PrimitiveType)mode, first, (uint)count);
        public static void DrawBuffer(DrawBufferMode mode) => gl.DrawBuffer((Silk.NET.OpenGL.DrawBufferMode)mode);
        public static void DrawBuffers(int n, DrawBuffersEnum[] bufs)
        {
            var arr = Array.ConvertAll(bufs, x => (Silk.NET.OpenGL.DrawBufferMode)x);
            gl.DrawBuffers((uint)n, arr);
        }
        public static unsafe void DrawElements(PrimitiveType mode, int count, DrawElementsType type, IntPtr indices) => gl.DrawElements((Silk.NET.OpenGL.PrimitiveType)mode, (uint)count, (Silk.NET.OpenGL.DrawElementsType)type, indices.ToPointer());
        
        public static void Enable(EnableCap cap) => gl.Enable((Silk.NET.OpenGL.EnableCap)cap);
        ...
        public static void FramebufferRenderbuffer(FramebufferTarget target, FramebufferAttachment attachment, RenderbufferTarget renderbuffertarget, int renderbuffer) =>
            gl.FramebufferRenderbuffer((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)attachment, (Silk.NET.OpenGL.GLEnum)renderbuffertarget, (uint)renderbuffer);
        ...
        public static void FramebufferTexture2D(FramebufferTarget target, FramebufferAttachment attachment, TextureTarget textarget, int texture, int level) =>
            gl.FramebufferTexture2D((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)attachment, (Silk.NET.OpenGL.GLEnum)textarget, (uint)texture, level);
        ...
        public static void GenerateMipmap(GenerateMipmapTarget target) => gl.GenerateMipmap((Silk.NET.OpenGL.TextureTarget)target);
        ...
        {
            fixed (bool* ptr = params_array) gl.GetBoolean((Silk.NET.OpenGL.GetPName)pname, ptr);
        }
        public static unsafe void GetBoolean(GetPName pname, out bool params_val)
        {
            gl.GetBoolean((Silk.NET.OpenGL.GetPName)pname, out params_val);
        }
        ...
        {
            fixed (float* ptr = params_array) gl.GetFloat((Silk.NET.OpenGL.GetPName)pname, ptr);
        }
        public static float GetFloat(GetPName pname)
        {
            gl.GetFloat((Silk.NET.OpenGL.GetPName)pname, out float val);
            return val;
        }
        public static unsafe void GetInteger(GetPName pname, out int params_val)
        {
            gl.GetInteger((Silk.NET.OpenGL.GetPName)pname, out int val);
            params_val = val;
        }
        public static unsafe void GetInteger(GetPName pname, int[] params_array)
        {
            fixed (int* ptr = params_array) gl.GetInteger((Silk.NET.OpenGL.GetPName)pname, ptr);
        }
        ...
        public static void GetProgram(int program, GetProgramParameterName pname, out int params_val) => gl.GetProgram((uint)program, (Silk.NET.OpenGL.GLEnum)pname, out params_val);
        public static string GetProgramInfoLog(int program) => gl.GetProgramInfoLog((uint)program);
        public static void GetShader(int shader, ShaderParameter pname, out int params_val) => gl.GetShader((uint)shader, (Silk.NET.OpenGL.GLEnum)pname, out params_val);
        ...
        {
            byte* ptr = gl.GetString((Silk.NET.OpenGL.GLEnum)name);
        ...
        public static void Hint(HintTarget target, HintMode mode) => gl.Hint((Silk.NET.OpenGL.HintTarget)target, (Silk.NET.OpenGL.HintMode)mode);
        public static bool IsEnabled(EnableCap cap) => gl.IsEnabled((Silk.NET.OpenGL.EnableCap)cap);
        ...
        public static void MemoryBarrier(MemoryBarrierFlags barriers) => gl.MemoryBarrier((Silk.NET.OpenGL.MemoryBarrierMask)barriers);
        
        public static void PixelStore(PixelStoreParameter pname, int param) => gl.PixelStore((Silk.NET.OpenGL.PixelStoreParameter)pname, param);
        public static void PolygonMode(MaterialFace face, PolygonMode mode) => gl.PolygonMode((Silk.NET.OpenGL.GLEnum)face, (Silk.NET.OpenGL.GLEnum)mode);
        ...
        public static void ReadBuffer(ReadBufferMode mode) => gl.ReadBuffer((Silk.NET.OpenGL.ReadBufferMode)mode);
        public static void RenderbufferStorage(RenderbufferTarget target, InternalFormat internalformat, int width, int height) =>
            gl.RenderbufferStorage((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)internalformat, (uint)width, (uint)height);
        ...
        public static unsafe void TexImage2D(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int border, PixelFormat format, PixelType type, IntPtr pixels) =>
            gl.TexImage2D((Silk.NET.OpenGL.GLEnum)target, level, (int)(Silk.NET.OpenGL.GLEnum)internalformat, (uint)width, (uint)height, border, (Silk.NET.OpenGL.GLEnum)format, (Silk.NET.OpenGL.GLEnum)type, pixels.ToPointer());
        ...
        public static unsafe void TexImage2D<T>(TextureTarget target, int level, PixelInternalFormat internalformat, int width, int height, int border, PixelFormat format, PixelType type, T[] pixels) where T : unmanaged
        {
            fixed (void* ptr = pixels)
                gl.TexImage2D((Silk.NET.OpenGL.GLEnum)target, level, (int)(Silk.NET.OpenGL.GLEnum)internalformat, (uint)width, (uint)height, border, (Silk.NET.OpenGL.GLEnum)format, (Silk.NET.OpenGL.GLEnum)type, ptr);
        }
        ...
        public static void TexParameter(TextureTarget target, TextureParameterName pname, int param) => gl.TexParameter((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)pname, param);
        public static void TexParameter(TextureTarget target, TextureParameterName pname, float param) => gl.TexParameter((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)pname, param);
        public static unsafe void TexParameter(TextureTarget target, TextureParameterName pname, int[] params_array) { fixed (int* ptr = params_array) gl.TexParameter((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)pname, ptr); }
        public static unsafe void TexParameter(TextureTarget target, TextureParameterName pname, float[] params_array) { fixed (float* ptr = params_array) gl.TexParameter((Silk.NET.OpenGL.GLEnum)target, (Silk.NET.OpenGL.GLEnum)pname, ptr); }
        ...
        public static unsafe void VertexAttribIPointer(int index, int size, VertexAttribIntegerType type, int stride, IntPtr pointer) =>
            gl.VertexAttribIPointer((uint)index, size, (Silk.NET.OpenGL.GLEnum)type, (uint)stride, pointer.ToPointer());
        ...
        public static unsafe void VertexAttribPointer(int index, int size, VertexAttribPointerType type, bool normalized, int stride, int offset) =>
            gl.VertexAttribPointer((uint)index, size, (Silk.NET.OpenGL.GLEnum)type, normalized, (uint)stride, (void*)offset);
