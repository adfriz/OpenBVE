#version 330 core
/*
 * RealSky Fragment Shader - LEGACY fallback (OpenGL 3.3 / GLSL 330)
 * -------------------------------------------------------------
 * This is the original single-pass fragment shader. It is used when
 * the OpenGL context does not support 4.3 (and therefore cannot run
 * the compute shader). The renderer picks this file at startup.
 */
